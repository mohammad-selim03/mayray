...
import { EcommerceIndustryPage } from "@/components/sections/ecommerce/EcommerceIndustryPage";
...
export async function generateMetadata(): Promise<Metadata> {
  return getCmsPageMetadata("ecommerce");
}

export default async function EcommercePage() {
  const content = await getCmsDocument("ecommerce");
  ...
  return (
    <main className="relative min-h-screen bg-[#f4f4f5] text-[#18181b]">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-x-0 top-0 z-0 h-[822px] overflow-hidden">
        <Image src="/ecommerce/bg-top.webp" alt="" fill sizes="100vw" className="object-cover object-top" priority />
      </div>

      <div className="relative z-10 px-5">
        <Navbar />
        <EcommerceIndustryPage content={content} />
        ...
        <div className="relative z-0 -mx-5 pt-[120px]">
          <div aria-hidden className="pointer-events-none absolute inset-x-0 bottom-0 z-0 h-[822px] overflow-hidden">
            <Image src="/ecommerce/bg-bottom.webp" alt="" fill sizes="100vw" className="object-cover object-bottom" />
          </div>
          <PricingCTABanner />
          <Footer />
        </div>
