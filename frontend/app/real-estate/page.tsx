...
import { RealEstateIndustryPage } from "@/components/sections/real-estate/RealEstateIndustryPage";
...
export async function generateMetadata(): Promise<Metadata> {
  return getCmsPageMetadata("real-estate");
}

export default async function RealEstatePage() {
  const content = await getCmsDocument("real-estate");
  ...
  return (
    <main className="relative min-h-screen bg-[#f4f4f5] text-[#18181b]">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-x-0 top-0 z-0 h-[822px] overflow-hidden">
        <Image src="/real-estate/bg-top.webp" alt="" fill sizes="100vw" className="object-cover object-top" priority />
      </div>

      <div className="relative z-10 px-5">
        <Navbar />
        <RealEstateIndustryPage content={content} />
        ...
        <div className="relative z-0 -mx-5 pt-[120px]">
          <div aria-hidden className="pointer-events-none absolute inset-x-0 bottom-0 z-0 h-[822px] overflow-hidden">
            <Image src="/real-estate/bg-bottom.webp" alt="" fill sizes="100vw" className="object-cover object-bottom" />
          </div>
          <PricingCTABanner />
          <Footer />
        </div>
