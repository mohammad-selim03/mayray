...
import type { ContactHeroContent } from "@/lib/cms/schema/documents/pages/contact";

export const ContactHero = ({ content }: { content: ContactHeroContent }) => (
  <section className="mx-auto w-full max-w-[1170px] px-4 pt-16 sm:px-6 lg:px-0 lg:pt-[114px]">
    <AnimateIn>
      <div className="mx-auto flex max-w-[564px] flex-col gap-6 text-center">
        <p className="text-[18px] leading-[27px] text-[#13a0e7]">{content.eyebrow}</p>
