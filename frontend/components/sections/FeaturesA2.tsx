...
const FALLBACK_VIDEO = "/features-svg/7.mp4";

/** The second feature block: Features collection, group B. */
export const FeaturesA2 = ({ content }: { content: HomeFeaturesContent }) => {
  const features = useSiteData().features;
  ...
  return (
    <>
      <section id="features-more" className="mx-auto mt-28 w-full max-w-[1170px] scroll-mt-28 space-y-24 px-4 sm:px-6 lg:px-0">
