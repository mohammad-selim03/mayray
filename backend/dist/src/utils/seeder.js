...
const seed = async () => {
    ...
    await prisma_1.default.blog.deleteMany();
    await prisma_1.default.testimonial.deleteMany();
    await prisma_1.default.integration.deleteMany();
    await prisma_1.default.useCase.deleteMany();
    await prisma_1.default.faqItem.deleteMany();
    await prisma_1.default.scalingStep.deleteMany();
    await prisma_1.default.siteSetting.deleteMany();
    const hashed = await bcryptjs_1.default.hash(process.env.ADMIN_PASSWORD ?? "Admin@123456", 12);
    ...
    await prisma_1.default.integration.createMany({
        data: [
    ...
    await prisma_1.default.testimonial.createMany({
        data: [
    ...
    await prisma_1.default.useCase.createMany({
        data: [
    ...
    await prisma_1.default.faqItem.createMany({
        data: [
    ...
    await prisma_1.default.scalingStep.createMany({
        data: [
    ...
    await prisma_1.default.siteSetting.createMany({
        data: [
