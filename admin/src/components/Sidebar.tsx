...
const links: NavItem[] = [
  ...
  { to: "/pages/blog",           label: "Blog Page",         icon: FileText },
  { to: "/pages/blog_detail",    label: "Blog Detail Page",  icon: FileText },
  { to: "/pages/not_found",      label: "404 Page",          icon: FileText },
  { to: "/pages/privacy",       label: "Privacy Policy", icon: FileText },
